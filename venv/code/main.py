...
name = "All classes in all groups trial 4"
...
plt.plot(np.arange(len(y4))+1, [0.885] * len(y4), color='g', label="Average All clients when train alone", linewidth=5)
plt.plot(np.arange(len(y4))+1, [0.55] * len(y4), color='y', label="Average All Clients when tested on whole test set", linewidth=5)
...
plt.plot(np.arange(len(y[0]))+1, [0.91] * len(y[0]), color='r', label="client 1_trained_alone", linewidth=5)
plt.plot(np.arange(len(y[0]))+1, [0.72] * len(y[0]), color='g', label="client 1_trained_alone_tested_on_whole_set", linewidth=5)
plt.xlabel("round")
plt.ylabel("accuracy")
plt.legend()
ymin, ymax = plt.ylim()
...
plt.plot(np.arange(len(y[1]))+1, [0.90] * len(y[0]), color='r', label="client 2_trained_alone", linewidth=5)
plt.plot(np.arange(len(y[0]))+1, [0.66] * len(y[0]), color='g', label="client 2_trained_alone_tested_on_whole_set", linewidth=5)
plt.xlabel("round")
plt.ylabel("accuracy")
plt.legend()
ymin, ymax = plt.ylim()
...
plt.plot(np.arange(len(y[0]))+1, [0.80] * len(y[0]), color='r', label="client 3_trained_alone", linewidth=5)
plt.plot(np.arange(len(y[0]))+1, [0.28] * len(y[0]), color='g', label="client 3_trained_alone_tested_on_whole_set", linewidth=5)
