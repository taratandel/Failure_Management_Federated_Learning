...
name = "All classes in all groups trial 9"
...
plt.plot(np.arange(len(y4))+1, [0.90] * 10000, color='r', label="Train on complete Data set", linewidth=5)
plt.plot(np.arange(len(y4))+1, [0.882] * 10000, color='g', label="Average All clients when train alone", linewidth=5)
plt.plot(np.arange(len(y4))+1, [0.65] * 10000, color='y', label="Average All Clients when tested on whole test set", linewidth=5)
...
plt.plot(np.arange(len(y[0]))+1, [0.84] * 10000, color='r', label="client 1_trained_alone", linewidth=5)
plt.plot(np.arange(len(y[0]))+1, [0.59] * 10000, color='g', label="client 1_trained_alone_tested_on_whole_set", linewidth=5)
plt.xlabel("round")
plt.ylabel("accuracy")
plt.legend()
ymin, ymax = plt.ylim()
...
plt.plot(np.arange(len(y[1]))+1, [0.89] * 10000, color='r', label="client 2_trained_alone", linewidth=5)
plt.plot(np.arange(len(y[0]))+1, [0.67] * 10000, color='g', label="client 2_trained_alone_tested_on_whole_set", linewidth=5)
plt.xlabel("round")
plt.ylabel("accuracy")
plt.legend()
ymin, ymax = plt.ylim()
