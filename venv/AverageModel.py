...
class AverageWeights:
    ...
    def __init__(self, model_params, loss=None):
        self.models_param = model_params
        self.loss = loss

    def weightedAverageModel(self):
        models_params = self.models_param
        total = 593 + 1877 + 43
        intercept = []
        weight = []
